...
<div class="card p-4 mb-5">
    <form method="GET" class="flex flex-wrap gap-3 items-end">
        ...
        <a href="{{ route('admin.booking.index') }}" class="btn-secondary">Reset</a>
        @endif
    </form>
</div>
            ...
            <tr>
                ...
                <td>
                    <div class="flex items-center gap-1.5 justify-end">
                        <a href="{{ route('admin.booking.show', $b) }}" class="p-1.5 text-slate-400 hover:text-primary-600 hover:bg-primary-50 rounded-lg transition-colors"><i data-lucide="eye" class="w-4 h-4"></i></a>
                        @if($b->status === 'pending')
                        <form method="POST" action="{{ route('admin.booking.approve', $b) }}">
                            @csrf @method('PATCH')
