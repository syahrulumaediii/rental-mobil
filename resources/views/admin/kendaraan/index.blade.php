        ...
        <table class="min-w-full text-left border-collapse divide-y divide-slate-100">
            <thead>
                <tr class="bg-slate-50/70 text-xs font-bold uppercase text-slate-400 tracking-wider">
                    ...
                    <th class="py-3.5 px-5">Denda / Jam</th> {{-- 🌟 KOLOM BARU --}}
            ...
            <tbody class="divide-y divide-slate-50 text-xs text-slate-600 whitespace-nowrap">
                ...
                <tr class="hover:bg-slate-50/30 transition-colors">
                    ...
                    {{-- 🌟 NILAI DENDA PER JAM BARU --}}
                    <td class="py-3.5 px-5 font-medium text-amber-700 text-sm bg-amber-50/10">
                        Rp {{ number_format($k->denda_per_jam, 0, ',', '.') }}
                    </td>
                ...
                @empty
                <tr>
                    <td colspan="7" class="text-center py-16 text-slate-400 font-medium">{{-- Colspan dinaikkan ke 7 karena kolom bertambah --}}
