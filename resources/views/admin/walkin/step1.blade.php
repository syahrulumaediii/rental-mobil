...
@section('breadcrumb', 'Admin / Walk-In / Data Pelanggan')
...
<div class="max-w-3xl mx-auto space-y-5 px-2 sm:px-0">
    ...
    <div class="card p-4 sm:p-5" id="formPelangganBaru">
        ...
        <form method="POST" action="{{ route('admin.walkin.step2') }}">
            @csrf
            ...
            <div class="flex flex-col-reverse sm:flex-row gap-3 mt-5 pt-4 border-t border-slate-100">
                <a href="{{ route('admin.dashboard') }}" class="btn-secondary w-full sm:w-auto text-center justify-center py-2.5 sm:py-2">Batal</a>
    ...
    <form id="formExisting" method="POST" action="{{ route('admin.walkin.step2') }}" class="hidden">
        @csrf
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    async function doSearch() {
        ...
        try {
            const res = await fetch('{{ route("admin.walkin.cari") }}', {
                method: 'POST',
                headers: {
