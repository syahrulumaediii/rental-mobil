...
@section('breadcrumb', 'Admin / Walk-In / Booking Kendaraan')
...
<div class="max-w-3xl mx-auto space-y-5 px-2 sm:px-0">
    ...
    <div class="card p-4 sm:p-5 border-l-4 border-l-green-500">
        ...
        <div class="mt-3">
            <a href="{{ route('admin.walkin.step1') }}" class="text-xs text-primary-600 hover:text-primary-700 font-medium inline-flex items-center gap-1">
    ...
    <div class="card p-4 sm:p-5">
        ...
        <form method="POST" action="{{ route('admin.walkin.store') }}">
            ...
            <div class="flex flex-col-reverse sm:flex-row gap-3 mt-5 pt-4 border-t border-slate-100">
                <a href="{{ route('admin.walkin.step1') }}" class="btn-secondary w-full sm:w-auto text-center justify-center py-2.5 sm:py-2">
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function updateEstimasi() {
        const mulaiVal = tanggalMulai.value;
        const selesaiVal = tanggalSelesai.value;
        ...
        if (mulaiVal && selesaiVal) {
            ...
            if (selesai >= mulai) {
                let durasi = Math.ceil((selesai - mulai) / (1000 * 60 * 60 * 24));
                if (durasi === 0) {
